        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Your trusted campus marketplace.<br />
          ...
          {/* Explore */}
          <div>
            <h6 className="font-semibold text-gray-800 mb-4">Explore</h6>
            <ul className="space-y-2 text-sm text-gray-600">
              <li><a href="#" className="hover:text-indigo-600 transition-colors">Marketplace</a></li>
              <li><a href="#" className="hover:text-indigo-600 transition-colors">Sell Now</a></li>
              <li><a href="#" className="hover:text-indigo-600 transition-colors">Categories</a></li>
              <li><a href="#" className="hover:text-indigo-600 transition-colors">Campus Events</a></li>
            </ul>
          </div>
